...
<table border="2" bordercolor="#blue" class="table">
  <tr>
   ...
   <tr>
	    ...
	    <th style="color:#006" bgcolor="#CCCCCC">Desc</th>
...
<cfset WbgcolorNo = "##ebfafa">
 ...
 <tr>
  ...
  <td bgcolor="#(ws_color)#">#TRIM(GetFoto.rep_name)#</td>
  <td bgcolor="#(ws_color)#">#TRIM(GetFoto.ph_desc)#</td> 
  <td bgcolor="#(ws_color)#"><a href="#TRIM(GetFoto.ph_link)#"><img src="#TRIM(GetFoto.ph_link)#" width="250"/></a></td>
