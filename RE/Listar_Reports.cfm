...
<table border="2" bordercolor="#blue" class="table">
   <tr></tr>
     <th colspan="10">
        <cfoutput> 
    ...
    <cfform name="disp" method="post" action="Listar_Reports.cfm">
        ...
        <tr> 
        <td colspan="1" valign="bottom" align="center"><input type="submit" name="editpho" value="Search"></td> 
   ...
   <tr>
        ...
        <th style="color:#006" bgcolor="#CCCCCC">Report</th>   
...
<cfset WbgcolorNo = "##ebfafa">
 ...
 <tr>
  ...
  <td bgcolor="#(ws_color)#"><a href="Reporte_upd.cfm?claveU=#TRIM(GetRep.rep_key)#">#TRIM(GetRep.rep_name)#</a></td>
 <td bgcolor="#(ws_color)#">#TRIM(GetRep.rep_name)#</td>
