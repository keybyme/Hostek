...
<cfset ws_proverbio = RandRange(01, 31)>
...
<cfquery name = "GetBiblia" dataSource = "luzyvidaDB_dsn"> 
   ...
   SELECT   lCapitulos.C_IdLibro
         ...
         where lCapitulos.C_IdLibro = 20 and 
               lCapitulos.C_Capitulo_Desc = #ws_proverbio#
 				...
 				<cfoutput>
        			<tr>
                        ...
                        <cfelse>
				        	...
				        	<td bgcolor="#(ws_color)#"><span class="style19">#ws_proverbio#</span></td>
