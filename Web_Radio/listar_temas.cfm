...
<CFQUERY NAME="GetVersos" datasource="luzyvidaDB_dsn">
...
<table border="1" bordercolor="#CC0000">
 ...
 <cfoutput> 
	...
	<td bgcolor="#(ws_color)#" style="color: white"> 
     <strong>#TRIM(GetVersos.V_versiculo)#</td>				 
	<td bgcolor="#(ws_color)#" style="color: white">#TRIM(GetVersos.V_Contenido)#</strong></div></td>
