...
<table border="2" bordercolor="#blue">
   <tr>
     <th colspan="10">
        <cfoutput> 
        <a href="add_cat_link.cfm">Add Category</a> 
        </cfoutput>     
     </th>
     </tr>
     <tr>
...
<cfset WbgcolorNo = "##ebfafa">
 ...
 <tr>
  ...
  <td align="center"><a href="upd_cat_link.cfm?claveU=#GetCat.lc_key#"><img src="../image/ico-edit.gif" width="16" height="16" alt=""/></a></td>					
  
  <td bgcolor="#(ws_color)#">#TRIM(GetCat.lc_cat_desc)#</td>
  
  
  <td align="center"><a href="del_cat_link.cfm?claveU=#GetCat.lc_key#"><img src="../image/ico-eliminar2.gif" width="20" height="20" alt=""/></a></td>               
