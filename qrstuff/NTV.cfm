...
<title>Nueva Traduccion Viviente</title>
</head>
...
<cfquery name = "GetLibro" dataSource = "wolffdb_dsn"> 
    ...
    <table width="100%" border="1" align="center">
            ...
            <th>
              ...
              <img src="image/qrstuff_image.gif" width="603" height="101" /></a></th>
         </tr>   
    </table>
    <table width="100%" border="1" align="center">
			<tr>        
                        ...
                        <cfif ws_time GT 9>
                          <cfif NOT (('#TRIM(GetBiblia.lec_pm_cap_end)#' EQ '#TRIM(GetBiblia.rv_capitulo)#') and
				        	...
				        	<td bgcolor="#(ws_color)#"><span class="style19">#TRIM(GetBiblia.rv_capitulo)#</span></td>
 				        	...
 				        	<td bgcolor="#(ws_color)#"><span class="style19">#TRIM(GetBiblia.rv_contenido_NTV)#</span></td>	 
						  </cfif>
                        <cfelse>
