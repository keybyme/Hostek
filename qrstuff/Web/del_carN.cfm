...
<form name="edit" method="post" action="act_del_carN.cfm">
	<cfoutput>
 
        <input type="hidden" name="ws_USER3" value="#claveUSER#"> 
		<input type="hidden" name="ws_carro_id" value="#GetTransacciones.rc_fk_car_id_key#">
    </cfoutput>
<cfoutput>
<table align="center">
    ...
    <tr>
        <td>Date:</td>
        <td><input name="rc_date" value="#GetTransacciones.rc_date#"></td>
    </tr>
    <tr>
        <td>Record:</td>
        <td><input name="rc_record" value="#GetTransacciones.rc_record#"></td>
    </tr>
    <tr>
        <td>Password:</td>
        <td><input name="rc_password" type="password" value=""></td> 
    <tr>          
    <tr>
