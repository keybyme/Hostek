...
<table align="center" border="2" bgcolor="#99CCCC">
	...
	<tr>
        <td>Note 1: </td>
        <td colspan="3"><cfinput name="pet_note1" value="#GetPet.pet_note1#" size="103"></td>
        </tr>                             
	<tr>
        <td>Note 2: </td>
        <td colspan="3"><cfinput name="pet_note2" value="#GetPet.pet_note2#" size="103"></td>
    </tr> 
	<tr>
        <td>Note 3: </td>
        <td colspan="3"><cfinput name="pet_note3" value="#GetPet.pet_note3#" size="103"></td>
    </tr> 
	<tr>        
