...
<cfquery name = "GetCar" dataSource = "wolffdb_dsn">
    ...
    WHERE car_id_key = <cfqueryparam value="#URL.claveU#" cfsqltype="CF_SQL_INTEGER">
...
<div id="main">
		...
		<div class="cols">
            ...
            <small>
              <cfoutput>Insurance company: &nbsp;
                        ...
                        Policy:  &nbsp;
                        <a href="#GetCar.car_insurance#">#GetCar.car_policy_number#</a> &nbsp;
				        <a href="#GetCar.car_vin_barcode#">Vin Number</a>
                        </cfoutput>
             </small>  
   ...
   <tr>
     <th colspan="5" style="color:#FFFFFF" bgcolor="#cccccc">
        <cfoutput>
        <a href="add_carN.cfm?claveR=#TRIM(GetCar.car_id_key)#&claveCARRO=#GetCar.car_name#&claveUSER=#GetCar.user_name#"> Add a Maintenance record</a>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<a href="edit_carN.cfm?claveR=#TRIM(GetCar.car_id_key)#">Edit Vehicle Information</a>	
        </cfoutput>     
     </th>
   </tr>
   <tr>
 ...
 <tr>
  ...
  <td align="center"><a href="upd_carN.cfm?claveU=#GetTransacciones.rc_id_key#&claveUSER=#GetCar.car_id_key#">
  <img src="img/ico-edit.gif" width="16" height="16">
  <td align="center"><a href="del_carN.cfm?claveU=#GetTransacciones.rc_id_key#&claveUSER=#GetCar.car_id_key#">
