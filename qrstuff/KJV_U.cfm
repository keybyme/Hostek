...
<tr><td>
<cfoutput>
This service will expire on #DATEFORMAT(TRIM(GetCodigos.cd_fecha_until),"mm/dd/yyyy")#, <a href="renovarE.cfm?claveU=#GetCodigos.cd_codigo#"> 
click here </a> to renew it.<br><br>&nbsp;
</cfoutput>  
</td></tr>
<cfelse>
  
  <cfoutput>
This account is disable, <a href="renovar.cfm?claveU=#URL.claveU#"> 
click here</a> to enable.
</cfoutput>
</cfif>
</table>
