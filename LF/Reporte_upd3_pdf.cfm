...
<cfset myImage=imageRead("#TRIM(GetFoto.ph_link)#")>
 <cfset imageRotate(myImage,0)> 
<!---  <cfimage source="#myImage#" action="writeToBrowser">  --->
  
<cfset myImage2=imageRead("#TRIM(GetFoto.ph_link2)#")>
 <cfset imageRotate(myImage,0)> 
<!---  <cfimage source="#myImage#" action="writeToBrowser">  --->
...
<div class="container text-center">
  <div class="row">
    <div class="col">
    <td><cfimage source="#myImage#" class="img-fluid" id="resize" action="writeToBrowser"></td>
    <td><cfimage source="#myImage2#" class="img-fluid" id="resize" action="writeToBrowser"></td>
