...
<cfhtmltopdf destination="pdfs/archivo.pdf" name="pdfdoc"
  source="https://www.keybyme.com/LF/Reporte_upd2_pdf_np.cfm?claveU=#TRIM(GetReporte.rep_key)#&ws_id=#SESSION.Auth.user_name#" overwrite="true"  
  orientation="portrait"  unit="in" pageheight="8" pagewidth="4" marginleft="1" marginright="1" /> 

             <cfoutput>
              <cfset ws_subject = "Safety Report (NP): ">
