      ...
      <body id="body">
            ...
            <div class="whole" style="page-break-before: avoid !important; ">
              <div id="box1">
                ...
                <cfset ws_phone=0>
                  ...
                  <p class="fs-6 text-wrap">This report is a follow up to the safety inspection completed on
                    #GetRep.rep_yyyymmdd#. The
                  ...
                  <p class="fs-6" id="no-space">
                    <cfif ws_phone neq 0>#ws_phone#<br></cfif>#GetRep.emp_email#
                  </p>
          </cfoutput>
        </div>
        <div id="footer" style="white-space: nowrap;">
          <cfoutput>#pagesTotal#</cfoutput>
        </div>
        </div>
        ...
        <cfset GetFoto.RecordCount=0>
          ...
          <cfset ws_page=0>
                ...
                <div id="box1">
                  <table class="table" width="100%">
                    ...
                    <cfset ws_page=ws_page + 1>
                      ...
                      <strong>
                        <p id="shaded">Observation <cfoutput>#ws_page#</cfoutput>
                        </p>
                      </strong>
                        ...
                        <tr>
                          <td>
                            ...
                            <div class="container text-center">
                              <div class="row">
                                <div class="col">
                                  <a href="#TRIM(GetFoto.ph_link)#"><img class="img-fluid"
                                      src="<cfoutput>#TRIM(GetFoto.ph_link)#</cfoutput>" id="resize"></a>

                                  <a href="#TRIM(GetFoto.ph_link2)#"><img class="img-fluid"
                                      src="<cfoutput>#TRIM(GetFoto.ph_link2)#</cfoutput>" id="resize"></a>
                                </div>
                              </div>
                            </div>
            ...
            <div class="counter-two-start">

              <img src="./jennings3.png" class="img-fluid" id="banner">
              <div id="line" style="margin-bottom:15px;"></div>

              <div class="container" style="border: solid 2px rgb(85, 85, 85);">
                            ...
                            <tr>
                              <td>
                                ...
                                <div class="container text-center">
                                  <div class="row">
                                    <div class="col">
                                      <a href="#TRIM(GetFoto.ph_link)#"><img class="img-fluid" src="" id="resize"></a>

                                      <a href="#TRIM(GetFoto.ph_link2)#"><img class="img-fluid" src="" id="resize"></a>
                                    </div>
                                  </div>
                                </div>
